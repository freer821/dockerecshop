...
?>
      <tr>
        ...
        <?php if ($this->_var['suppliers_list'] != 0): ?>
        <td><div align="right"><?php echo empty($this->_var['suppliers_name']['\$package']['suppliers_id']) ? $this->_var['lang']['restaurant'] : $this->_var['suppliers_name']['\$package']['suppliers_id']; ?></div></td>
        <?php endif; ?>
    ...
    <tr>
      ...
      <?php if ($this->_var['suppliers_list'] != 0): ?>
      <td><div align="right"><?php echo empty($this->_var['suppliers_name']['\$goods']['suppliers_id']) ? $this->_var['lang']['restaurant'] : $this->_var['suppliers_name']['\$goods']['suppliers_id']; ?></div></td>
      <?php endif; ?>
